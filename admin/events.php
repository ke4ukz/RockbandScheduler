<?php
/**
 * Rockband Scheduler - Admin Events Management
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="events.php" title="Events"><i class="bi bi-calendar-event"></i><span class="d-lg-none ms-2">Events</span></a>
                    </li>
                    <li class="nav-item">
